    ...
    const getStatusBadge = (vaccination: any) => {
        if (vaccination.isScheduled) {
            if (vaccination.completed) {
                ...
                return <Badge variant="destructive">Agendada
                    (Atrasada {Math.abs(vaccination.daysUntilEvent)} dias)</Badge>;
            } else if (vaccination.status === 'upcoming') {
                return <Badge variant="secondary" className="bg-blue-100 text-blue-800">Agendada
                    ({vaccination.daysUntilEvent} dias)</Badge>;
            } else {
            ...
            switch (vaccination.status) {
                ...
                case 'upcoming':
                    return <Badge variant="secondary" className="bg-green-100 text-green-800">Próxima
                        ({vaccination.daysUntilNext} dias)</Badge>;
                default:
                    ...
                    <CardContent>
                        {loading ? (
                            <div className="text-center py-8">
                                <div
                                    className="animate-spin rounded-full h-8 w-8 border-b-2 border-green-600 mx-auto"></div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {vaccination.isScheduled ? (
                                                    ...
                                                    <div className="text-sm text-gray-600">
                                                        <p>
                                                            <strong>Data {(vaccination as any).completed ? 'Aplicada' : 'Agendada'}:</strong> {formatDate((vaccination as any).date)}
                                                        </p>
                                                    ...
                                                    <>
                                                        <div
                                                            ...
                                                            <div>
                                                                <p>
                                                                    <strong>Vacina:</strong> {(vaccination as any).vaccineType?.name}
                                                                </p>
                                                                <p><strong>Data de
                                                                    Aplicação:</strong> {formatDate((vaccination as any).application_date)}
                                                                </p>
                                                                {(vaccination as any).next_dose_date && (
                                                                    <p><strong>Próxima
                                                                        Dose:</strong> {formatDate((vaccination as any).next_dose_date)}
                                                                    </p>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div>
                                                                {(vaccination as any).batch_number && (
                                                                    <p>
                                                                        <strong>Lote:</strong> {(vaccination as any).batch_number}
                                                                    </p>
                                                                )}
                                                                {(vaccination as any).manufacturer && (
                                                                    <p>
                                                                        <strong>Fabricante:</strong> {(vaccination as any).manufacturer}
                                                                    </p>
                                                                )}
                                                                {(vaccination as any).responsible && (
                                                                    <p>
                                                                        <strong>Responsável:</strong> {(vaccination as any).responsible}
                                                                    </p>
                                                                )}
                                                            </div>
                                                        </div>
